...
int main()
{
    ...
    sort(diskRequests.begin(),diskRequests.end());
    int totalSeekTime=0;
    int currPos=head;
    ...
    cout<<"Total seek time using SSTF disk scheduling:"<<totalSeekTime<<endl;
    cout<<"Average seek time using SSTF disk scheduling:"<<totalSeekTime*1.0/n<<endl;
    return 0;
}